...
// Shared markdown renderer used by chat / insights / logistics chat panel.
...
// globals.css under `.chat-markdown` so every consumer gets the same
// look without re-importing a CSS module.
